...
**Scientist** and **Educator** at the intersection of **AI**, **Healthcare**, **Medical Imaging**, **Education** and **Cancer Research**, with a background in **Data Science**, **Cytopathology**, and **Psychology**. I am currently involved in the development of a liquid biopsy-based diagnostic test for early cancer detection, mentoring future data professionals, university lecturer in a Digital Healthcare Master's (Intro to AI Applied to Medical Imaging) and serving as the Secretary of the [European Advisory Committee of Cytotechnology](https://www.efcs.eu/links/eacc-advisory-commitee/).
